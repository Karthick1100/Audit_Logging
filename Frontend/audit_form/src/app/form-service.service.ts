...
export class FormServiceService {
  ...
  public addForm({firstName,lastName,email,jobTitle,address,gender,dob,phone,lastEditedBy,formId=100}:Form):Observable<Form>{
  ...
  public updateForm(frm:Form,lastEditedBy:String,formId:Number):Observable<Form>{
  ...
  public getAuditDetails(formId:Number):Observable<formChange>{
    return this.http.get<formChange>(`${this.apiServiceUrl}/audit/auditLog/${formId}}`);
  }
}
